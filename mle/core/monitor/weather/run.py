...
The generated reports are stored in `./mle/data/monitor/weather/` with
...
# This is the path where the monitored weather is going to be stored.
_DIR_PATH = 'data/monitor/weather'
